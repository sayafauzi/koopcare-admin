...
INSERT INTO members (id, full_name, nik, phone, email, pin, status, role, monthly_income, tenure_months, existing_loan_balance, has_collateral)
VALUES (1, 'Admin Utama', '1234567890123456', '+628123456789', 'admin@koopcare.com',
        ...
        'ACTIVE', 'admin', 0, 0, 0, FALSE);

-- Anggota contoh (PIN dummy, tidak untuk login)
INSERT INTO members (id, full_name, nik, phone, pin, status, role, balance, monthly_income, tenure_months, existing_loan_balance, has_collateral, code_gender, birth_date, education, family_status, occupation, own_car, own_realty, children_count, family_members, employed_days, last_phone_change_days)
VALUES
    ...
    (4, 'Budi Santoso', '3205555555555555', '+628123456781', '$2a$12$dummy', 'INACTIVE', 'member', 0, 0, 0, 0, FALSE),
    (5, 'Ahmad Fauzi (nama-sama)', '3201234567890124', '+628123456782', '$2a$12$dummy', 'INACTIVE', 'member', 0, 0, 0, 0, FALSE),
    (6, 'Reza', '3201234567890125', '+628123456783', '$2a$12$dummy', 'INACTIVE', 'member', 0, 0, 0, 0, FALSE);

-- ============================================================================
-- 2. KODE UNDANGAN UNTUK ADMIN BARU
-- ============================================================================
INSERT INTO invite_codes (code, created_by, valid_until, max_uses, used_count, status)
VALUES ('KOD-ABC123', 1, DATE_ADD(NOW(), INTERVAL 30 DAY), 1, 0, 'active');

-- ============================================================================
-- 3. KYC SUBMISSIONS (Pengajuan verifikasi)
-- ============================================================================
INSERT INTO kyc_submissions (member_id, full_name, nik, phone, status, ktp_photo_url, selfie_photo_url, notes, reviewed_by, reviewed_at)
VALUES
...
-- ============================================================================
INSERT INTO transactions (member_id, type, amount, description, created_at)
VALUES
